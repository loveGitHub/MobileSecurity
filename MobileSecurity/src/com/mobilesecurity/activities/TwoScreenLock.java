...
import com.blahti.example.drag3.DeleteZone;
...
public class TwoScreenLock extends Activity implements View.OnLongClickListener,
 ...
 */
	...
	public void addNewImageToScreen(int resourceId, int chk) {
		/*
		...
		switch (chk) {
		case 1:
			imageHolder = (FrameLayout) findViewById(R.id.image_source_frame);
			break;
		case 2:
			imageHolder = (FrameLayout) findViewById(R.id.image_source_frame2);
			break;
		case 3:
			imageHolder = (FrameLayout) findViewById(R.id.image_source_frame3);
			break;
		case 4:
			imageHolder = (FrameLayout) findViewById(R.id.image_source_frame4);
			break;
	...
	public void addNewImageToScreen() {
		...
		int resourceId2 = R.drawable.photo1;
		addNewImageToScreen(resourceId2, 2);

		int resourceId3 = R.drawable.photo2;
		addNewImageToScreen(resourceId3, 3);

		int resourceId4 = R.drawable.image0;
		addNewImageToScreen(resourceId4, 4);
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (gridView == null)
			...
			gridView.setAdapter(new TwoScreenImageCellAdapter(this));
